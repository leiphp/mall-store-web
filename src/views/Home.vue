...
<template>
  <div class="home" id="home" name="home">
    ...
    <div class="block">
      <el-carousel height="460px">
        <el-carousel-item v-for="item in carousel" :key="item.id">
          <a target="_blank" :href="item.url"><img style="height:460px;" :src="item.pic" :alt="item.name" /></a>
        </el-carousel-item>
      </el-carousel>
    </div>
    <!-- 轮播图END -->
    ...
    <div class="main-box">
      <div class="main">
         <!-- 秒杀活动 -->
        <div class="phone" v-if="Object.keys(promotionList).length>0">
          <div class="box-hd">
...
7x4iTALjhcgVQSIl3v87w5vePcY/AQYAFYR6skFSqBUAAAAASUVORK5CYII=" alt="小米闪购">
        ...
        <div class="prolist">
          <div class="box-hd">
            ...
            <div class="more"><router-link :to="{ path: '/newgoods' }">查看全部<i data-v-57abdd9a="" class="el-icon-d-arrow-right"></i></router-link></div>
          </div>
          <div class="box-bd">
...
.flash-promotion-data li a .thumb img{
    width: 160px;
    height: 160px;
}
.flash-promotion-data li a .title{
    margin: 0 20px 3px;
    font-size: 14px;
    font-weight: 400;
...
.flash-promotion-data li a .desc{
    height: 18px;
    margin: 0 20px 12px;
    font-size: 12px;
    text-overflow: ellipsis;
...
.flash-promotion-data li a .price{
    margin: 0;
    color: #ff6709;
}
